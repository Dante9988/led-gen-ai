  ...
  return (
    <div>
      ...
      <p className="text-[#888] leading-relaxed mb-6">
        When you share your personal Closely AI link on social media or in DMs, prospects are directed to a beautifully designed, high-converting capture form. The form gathers essential contact information alongside specific intent (such as interest in credit fixing, travel packaging, or wealth education).
      </p>

      <h2 className="text-2xl font-semibold text-white mb-4 mt-8">Using Capture Links</h2>
      <p className="text-[#888] leading-relaxed mb-4">
        Every agent gets a unique <strong>Slug</strong> (e.g., <code>closely.ai/apply/janesmith</code>).
      </p>
