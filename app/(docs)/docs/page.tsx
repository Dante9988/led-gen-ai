  ...
  return (
    <div>
      ...
      <p className="text-lg text-[#888] leading-relaxed mb-8">
        Welcome to the ProspectFlow documentation. Here you will find everything you need to set up, manage, and scale your personal network marketing pipeline.
      </p>

      <div className="h-px bg-white/[0.06] mb-8" />

      <h2 className="text-2xl font-semibold text-white mb-4 mt-8">What is ProspectFlow?</h2>
      <p className="text-[#888] leading-relaxed mb-6">
        ProspectFlow is an AI-native lead capture and CRM workspace built specifically for network marketing agents. Instead of managing chaotic spreadsheets and unstructured notes, ProspectFlow provides you with structured visual pipelines and intelligent communication tools to convert leads faster.
      </p>

      <h2 className="text-2xl font-semibold text-white mb-4 mt-8">Who is it for?</h2>
      <p className="text-[#888] leading-relaxed mb-6">
        Whether you are promoting credit fixing solutions, travel packages, identity monitoring software, or wealth education, ProspectFlow acts as your personal command center. It operates alongside your primary MLM company, giving you complete ownership of your personal lead generation and follow-up activities.
      </p>
