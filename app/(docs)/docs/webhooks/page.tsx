  ...
  return (
    <div>
      ...
      <p className="text-lg text-[#888] leading-relaxed mb-8">
        Learn how to automate lead entry from external platforms into ProspectFlow.
      </p>
      ...
      <p className="text-[#888] leading-relaxed mb-6">
        Webhooks allow other tools and platforms (like independent landing pages, specialized funnel software, or Zapier automations) to programmatically send incoming prospect data directly into your ProspectFlow CRM without manual entry.
      </p>

      <h2 className="text-2xl font-semibold text-white mb-4 mt-8">How It Works</h2>
      <p className="text-[#888] leading-relaxed mb-6">
        By providing an external application with your specific Webhook Intake URL, that platform can seamlessly <code>POST</code> JSON payloads containing user data to your ProspectFlow account in real time. For example, if someone fills out a custom Typeform evaluating their credit score, the form leverages the webhook to immediately draft a new pipeline card for them inside ProspectFlow.
      </p>
